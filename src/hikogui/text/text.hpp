...
#include "text_shaper_line.hpp" // export
#include "text_style_set.hpp" // export
#include "text_style.hpp" // export

hi_export_module(hikogui.text);
